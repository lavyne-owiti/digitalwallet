# Generated by Django 4.0.6 on 2022-09-29 14:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination_acc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='destination_acc', to='wallet.customer')),
                ('origin_acc', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='origin_acc', to='wallet.customer')),
